...
\title{Introduction to Smooth Manifolds: Orientations Solutions}
\begin{document}
\maketitle
...
Notation $X \mathbin{\lrcorner} \omega = i_X \omega$
...
then $\left. (N \mathbin{\lrcorner} \Omega) \right|_S \equiv \left. i_N\Omega \right|_S $ orientation form for $S$ with respect to this orientation.
\end{proposition}
...
\phantom{proof Let } $\omega  = \left. (N \mathbin{\lrcorner} \Omega) \right|_S$ $m-1$ form.
